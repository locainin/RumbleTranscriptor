...
class SettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.keep_video_checkbox.setObjectName('keepVideoCheckbox')
...
class RumbleTranscriber(QWidget):
    ...
    def apply_styles(self):
        # App-wide stylesheet moved to external QSS file
        try:
            ...
            # Non-fatal: keep running without styles if loading fails
